    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p style="font-size: 16px; color: #495057; margin-bottom: 25px;">
                New User has been contacted. Please review and respond promptly:
            </p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <a href="tel:{{ $company_name }}" style="color: #007bff;">{{ $company_name }}</a>
                    </div>
                </div>
                @endif
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <div class="info-value">
                        <a href="tel:{{ $messageText }}" style="color: #007bff;">{{ $messageText }}</a>
                    </div>
                </div>
                @endif
        ...
        <div class="footer">
            <p>This is an automated notification from Relia Track</p>
