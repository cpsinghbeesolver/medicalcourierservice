        ...
        <div class="form-section">
            ...
            <form id="changePasswordForm">
                <div class="input-wrapper">
                    <label for="current_password" class="form-label">Current Password <span class="astrik">*</span></label>
                ...
                <div class="input-wrapper">
                    <label for="new_password" class="form-label">New Password <span class="astrik">*</span></label>
                    <input type="password" maxlength="64" class="form-control" id="new_password" name="new_password" placeholder="New password" required>
                ...
                <div class="input-wrapper">
                    <label for="new_password_confirmation" class="form-label">Confirm New Password <span class="astrik">*</span></label>
                    <input type="password" maxlength="64" class="form-control" id="new_password_confirmation" name="new_password_confirmation" placeholder="Confirm new password" required>
