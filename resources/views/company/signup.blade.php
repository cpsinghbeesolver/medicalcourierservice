        ...
        <div class="right-section">
            <div class="login-container">
                ...
                <div class="login-header">
                    <h2>Sign Up</h2>
                    <h5>Create your company account to start delivering healthcare, reliably.</h5>
                </div>
                ...
                <form id="loginForm" method="POST" action="{{ route('signup') }}">
                    @csrf
                    <div class="form-group">
                        <label for="name">Your Name</label>
                        <input type="name" id="name" name="name" value="{{old('name')}}" required placeholder="Enter your full name">
                    </div>
                    <div class="form-group">
                        <label for="company_name">Company Name</label>
                        <input type="company_name" id="company_name" name="company_name" value="{{old('company_name')}}" required placeholder="Enter company name">
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit" class="btn-login" id="loginBtn">Sign Up</button>
                </form>
            </div>
        </div>
    </div>
