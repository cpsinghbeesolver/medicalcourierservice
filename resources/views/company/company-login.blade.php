    ...
    <div class="login-wrapper">
        ...
        <div class="right-section">
            <div class="login-container">
                ...
                <form id="loginForm" method="POST" action="{{ route('company-login') }}" autocomplete="off">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrapper">
                            <input type="password" maxlength="128" id="password" name="password" required placeholder="Please enter password" autocomplete="new-password">
